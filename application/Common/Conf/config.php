...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Chanpin'),
        ...
        'TMPL_PARSE_STRING'=>array(
         ...
         PT_APP_KEY => 'd08a955863056cb9ac495d40',          //跑腿-待发送的应用程序(appKey)，只能填一个。
        PT_MASTER_SECRET => 'b4765d0e3ac1d198f25c041d',     //跑腿-主密码
        PN_APP_KEY => 'd08a955863056cb9ac495d40',            //跑客-待发送的应用程序(appKey)，只能填一个。
        PN_MASTER_SECRET => 'b4765d0e3ac1d198f25c041d'      //跑客-主密码
);
